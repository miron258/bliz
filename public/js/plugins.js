...
ngApp.factory('callbackModal', function (vModal) {
    return vModal({
        ...
        controllerAs: 'myFormOrderCtrl',
        templateUrl: '/modal-form-order'
    });
});
ngApp.factory('reviewModal', function (vModal) {
    return vModal({
        // controller: 'formOrderCtrl',
        templateUrl: '/modal-add-review'
    });
});
 ...
 * @requires $scope
 * */
ngApp.controller('siteCtrl', function ($scope) {

    let textMiddle = angular.element('.block-text .text-middle');
    let textBottom = angular.element('.block-text .text-bottom');

    $scope.viewReadmore = true;
...
.controller('UibDatepickerController', ['$scope', '$element', '$attrs', '$parse', '$interpolate', '$locale', '$log', 'dateFilter', 'uibDatepickerConfig', '$datepickerLitera